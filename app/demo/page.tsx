...
type Screen = 'home' | 'my-profile' | 'scanned-qr' | 'my-connections' | 'stage1' | 'stage2' | 'prioritization';
      ...
      <div className="container">
            ...
            <div className="hero">
              ...
              <div style={{ display: 'flex', gap: '20px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <button className="btn" onClick={() => setScreen('my-profile')}>
                  I'm Person A (Show QR) →
                </button>
                <button className="btn btn-secondary" onClick={() => setScreen('scanned-qr')}>
                  I'm Person B (Scan QR) →
                </button>
              </div>
            </div>
        ...
        {screen === 'my-profile' && (
          <div className="screen active">
            <div className="results-header">
              <div className="results-header-label">
                Your Collaboration Profile · Generated
              </div>
              ...
              <div className="profile-header-container">
                ...
                <div className="profile-qr-card">
                  ...
                  <div className="qr-url">
                    <span>mission-match.app/u/jordan-lee</span>
                  </div>
                </div>

                {/* Profile Info */}
                <div className="profile-header-content">
                  <h1>{PROFILES.jordan.name}</h1>
                  <p className="role">{PROFILES.jordan.role} @ TechCorp</p>
                  <p className="description">
                    Profile extracted from 18 months of AI conversation history. Evidence-based, not personality tests.
                  </p>
                  <div className="profile-actions">
                    <button className="btn-small btn-primary-small">
                      ⬇ Download QR
                    </button>
                    <button className="btn-small btn-outline-small">
                      📋 Copy Link
                    </button>
                  </div>
                </div>
            ...
            {/* Aspects with Evidence */}
            <div className="section">
              <h2 className="section-header">
                <span className="icon">◈</span> Your Collaboration Aspects
              </h2>
              <div className="aspects-grid">
                {ASPECT_EVIDENCE.map((aspect, i) => (
                  <div key={i} className="aspect-detailed">
                    ...
                    <div className="evidence-box">
                      <div className="label">{aspect.evidence.label}</div>
                      <div className="quote">"{aspect.evidence.quote}"</div>
                      <div className="source">{aspect.evidence.source}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="section" style={{ maxWidth: '800px', margin: '60px auto' }}>
              <h2 className="section-header">
                <span className="icon">👥</span> What You Need in a Collaborator
              </h2>

              <div className="info-box">
                <h4>You'd Thrive With Someone Who:</h4>
                <ul>
                  <li>Brings bold vision and strategic thinking (your score: 45/100)</li>
                  <li>Makes fast decisions based on intuition (your score: 38/100)</li>
                  <li>Comfortable with ambiguity and rapid iteration (your score: 52/100)</li>
                  <li>Can help you say "no" and protect your calendar</li>
                </ul>
              </div>

              <div className="info-box warning-box">
                <h4>⚠ Watch Points for Collaborators</h4>
                <ul>
                  <li>You need clarity before moving (vs gut-instinct deciders)</li>
                  <li>You value financial stability ($115k steady income)</li>
                  <li>You struggle to say no (35+ hours meetings/week)</li>
                </ul>
              </div>
            </div>
            ...
            <div className="cta-section">
              ...
              <p>Your profile is complete and portable. Now let's find collaborators who complement your strengths.</p>
              <button className="btn" onClick={() => setScreen('stage1')}>
                👥 Find Collaborators
              </button>
              <div className="cta-actions">
                <button className="btn-small btn-outline-small">⬇ Export Profile</button>
                <button className="btn-small btn-outline-small">✏ Edit Profile</button>
              </div>
            </div>
          </div>
        )}
